class QrCreationLocators:
    def __init__(self, page):
        ...
        self.website_qr_type = page.locator("//input[@data-qr_type='Url']/../../..")
        self.pdf_qr_type = page.locator("//input[@value='pdf']/../../..")
        self.links_qr_type = page.locator("//input[@value='links']/../../..")
        self.vcard_qr_type = page.locator("//input[@value='vcard']/../../..")
        self.business_qr_type = page.locator("//input[@value='business']/../../..")
        self.images_qr_type = page.locator("//input[@value='images']/../../..")
        self.video_qr_type = page.locator("//input[@value='video']/../../..")
        self.apps_qr_type = page.locator("//input[@value='app']/../../..")
        self.coupon_qr_type = page.locator("//input[@value='coupon']/../../..")
        self.mp3_qr_type = page.locator("//input[@value='mp3']/../../..")
        self.menu_qr_type = page.locator("//input[@value='menu']/../../..")
        self.wifi_qr_type = page.locator("//input[@value='wifi']/../../..")
        self.facebook_qr_type = page.locator("//input[@value='facebook']/../../..")
        self.instagram_qr_type = page.locator("//input[@value='instagram']/../../..")
        self.social_media_qr_type = page.locator("//input[@value='social']/../../..")
        self.whatsapp_qr_type = page.locator("//input[@value='whatsapp']/../../..")
        ...
        # opening hours
        self.monday_checkbox = page.locator("label[for='checkboxMon']")
