class PaymentPageLocators:
    def __init__(self, page):
        ...
        self.expiry_date_input = self.frame_payment.locator(
            "//input[@id='Field-expiryInput']"
        )
        self.cvc_code_input = self.frame_payment.locator(
            "//input[@id='Field-cvcInput']"
        )
        self.payment_country_dropdown = self.frame_payment.locator(
            "//select[@id='Field-countryInput']"
        )
        self.payment_zip_input = self.frame_payment.locator(
        ...
        self.billing_full_name_input = self.frame_billing.locator(
            "//input[@id='Field-nameInput']"
        )
        self.billing_country_input = self.frame_billing.locator(
            "//input[@id='Field-countryInput']"
        )
        self.billing_address_line1_input = self.frame_billing.locator(
            "//input[@id='Field-addressLine1Input']"
        )
        self.billing_city_input = self.frame_billing.locator(
            "//input[@id='Field-localityInput']"
        )
        self.billing_oblast_input = self.frame_billing.locator(
            "//select[@id='Field-administrativeAreaInput']"
        )
        self.billing_postal_code_input = self.frame_billing.locator(
            "//input[@id='Field-postalCodeInput']"
        )
