...
class TestNSFSignUpFlow(BaseTest):
    ...
    @pytest.mark.parametrize("qr_create_method",
                             [
                                "wifi_qr_create", "instagram_qr_create",
    ...
    @pytest.mark.parametrize("file_format, resolution", [
        ("PNG", "512x512"),
        ("PNG", "1024x1024"),
    ])

    def test_dpf_sign_up_qr_type(self, navigate_to_nsf_page, qr_create_method, fake_email, file_format, resolution):
        ...
        # self.my_qr_codes_page.locator.download_button.click()
        self.my_qr_codes_page.download_parametrize_files(file_format, resolution, "download_qr_path/")
