...
class TestNSFSignUpFlowEps(BaseTest):
    ...
    @allure.title("Create QR code and sign up with {qr_create_method} at {resolution} resolution")
    ...
    @pytest.mark.parametrize("resolution", resolution_qr_code_images)
    @allure.title("Create Website/Menu QR code and sign up with {qr_create_method} at {resolution} resolution")
