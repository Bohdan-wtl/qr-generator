...
from config import languages, qr_create_methods, resolution_qr_code_images, png_download_format
...
class TestDPFSignUpFlowPng(BaseTest):
    ...
    def test_dpf_sign_up_qr_type(self, navigate_to_dpf_page, qr_create_method, fake_email, resolution):
        ...
        self.my_qr_codes_page.download_parametrize_files(png_download_format, resolution)
