...
@allure.feature(f"DPF Flow - EPS Format - {os.getenv('BROWSER')}")
class TestDPFSignUpFlowEps(BaseTest):
    @allure.story("QR Code Creation with EPS Download")
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.description("Create QR code, complete DPF signup, and download EPS format")
    ...
    @allure.story("Website QR Creation with EPS Download")
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.description("Create website QR code, complete DPF signup, and download EPS format")
