...
class TestCFFSignUpFlowEps(BaseTest):
    ...
    @allure.description(
        f"Verify QR code {qr_create_methods} creation and EPS download functionality with various methods and resolutions {resolution_qr_code_images}"
    )
    ...
    @allure.description(
        "Verify website QR code creation and EPS download functionality"
    )
