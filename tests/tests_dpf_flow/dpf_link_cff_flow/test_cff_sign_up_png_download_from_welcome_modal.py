...
class TestCFFSignUpFlowPng(BaseTest):
    ...
    @allure.title("Create and download QR code with different creation methods and resolutions")
    @allure.description("Test creates QR code using different methods, completes signup flow and downloads PNG file")
    ...
    @allure.description("Test creates website/menu QR code, completes signup flow and downloads PNG file")
    @allure.severity(allure.severity_level.CRITICAL)
