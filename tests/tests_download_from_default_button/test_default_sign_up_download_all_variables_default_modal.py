...
from config import languages, download_params_default_modal
...
class TestDefaultSignUpFlow(BaseTest):
    ...
    def test_default_sign_up_website_qr_type(self, page, sign_up_fixture, qr_create_method, fake_email):
