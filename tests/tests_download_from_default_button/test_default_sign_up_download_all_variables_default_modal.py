...
class TestDefaultSignUpFlowAll(BaseTest):
    ...
    @allure.description("Verify the complete flow of creating and downloading a website QR code with different formats and resolutions")
    ...
    def test_default_sign_up_website_qr_type(
        ...
        for params in download_params_default_modal:
            with allure.step(
                ...
                with allure.step(f"Select format {params['file_format']} and resolution {params['resolution']}px"):
